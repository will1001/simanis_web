...
<div class="flex actionContainer justify-between ml-4  mt-3 h-14 cursor-pointer">
    ...
    <div class="flex border rounded-md shadow-md ml-3 cursor-pointer w-[200px]">
...
<table class="actionContainer justify-between ml-4 bg-white mt-3 h-20"> 
  <tr class="bg-tableColor-900 text-white text-center h-16 gap-3">
    ...
    <th class="text-left p-2 w-[200px]">Badan Usaha</th>
    <th class="text-left ">
        <div class="flex text-left gap-1 my-auto ml-5 w-[200px] "><img src="{{ asset('/icon svg/iconBawahAtas.svg') }}" alt="" class="flex"> Kabupaten</div>
    </th>     
    <th class="text-left">
        <div class="flex justify-center gap-1 my-auto w-[200px]"><img src="{{ asset('/icon svg/iconBawahAtas.svg') }}" alt="" class="flex"> Jumlah Dana</div>
    </th>              
  ...
  <td class="cursor-pointer text-center pl-2"><span class="py-auto px-1 border-2 rounded-md"><input type="checkbox" name="all" id="all" class=" invisible "></span></th>
    ...
    <td class="text-left text-slate-700 font-bold"><span class="flex justify-center gap-1 my-auto w-[200px]">Rp 200.000.000</span></td>
