    ...
    <tr class="bg-white">
      ...
      <td class="text-center p-2">
        <div class="flex ml-2">
          ...
          <div class="bg-ditolakTextColor p-2 rounded-lg w-[30px] mr-2">
            <img onclick="openPopUpDelete('{{$item->id}}')" class="cursor-pointer mr-2 w-[70px] h-[20px]" src="{{ asset('/Icon-svg/delete.svg') }}" alt="icon">
          </div>
          <button class="bg-buttonColor-900 px-[25px] py-[10px] rounded-xl text-white mr-2" type="submit" id="button-addon2"><a class="text-white" href="/admin/user/password/reset/{{$item->id}}">Reset</a></button>
        </div>
      </td>
    </tr>
    @endforeach
