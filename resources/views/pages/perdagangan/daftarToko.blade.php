...
<form action="/perdagangan/daftarToko/formTambahToko" method="get" class="flex  w-[140px] h-[52px] bg-blue-400 rounded-lg bg-cover mt-4 ml-[850px] shadow-md">
    <button type="submit"  class=" text-white text-sm font-bold my-auto mx-auto h-[17px] ">Tambah Toko</button>
</form>  
...
<table class="badan_usaha_container ml-4 bg-white mt-3 h-20"> 
  <tr class="bg-tableColor-900 text-white text-center h-16 gap-3">
    ...
    <th class="text-left p-2 "><span class="flex justify-center my-auto mx-6">NPWP</span></th>   
    <th class="text-left p-2 "><span class="flex justify-center my-auto mx-6">Email</span></th>   
    <th class="text-left ">
        <div class="flex text-left gap-1 my-auto ml-5  "><img src="{{ asset('/Icon-svg/iconBawahAtas.svg') }}" alt="" class="flex">Kab. / Kota</div>
    </th>     
    <!-- <th class="text-left p-2 "><span class="">Status</span></th>    -->
    <th class="rounded-tr-xl">Aksi</span></th>   
  </tr>
  @foreach($ListToko as $key=>$item)
