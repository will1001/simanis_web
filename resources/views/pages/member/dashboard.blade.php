...
<div class="badan_usaha_container">
    ...
    <div class="progress" style="width: 200px;">
        <div class="progress-bar" role="progressbar" style="width: {{round($userDataProgress[$key],0) > 100 ?100:round($userDataProgress[$key],0)}}%;height: 20px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">{{round($userDataProgress[$key],0) > 100 ?100:round($userDataProgress[$key],0)}}%</div>
    </div>
