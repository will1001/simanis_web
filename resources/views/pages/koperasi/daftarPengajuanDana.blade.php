...
<table class="badan_usaha_container ml-4 bg-white mt-3 h-20 w-[1200px]">
    <tr class="bg-tableColor-900 text-white text-center h-16 gap-3">
        ...
        <th class="text-left p-2 "><span class="flex justify-center my-auto mx-6">Tanggal Pengajuan</span></th>
        <th class="text-left p-2 "><span class="flex justify-center my-auto mx-6">Tanggal Diterima/Ditolak</span></th>
...
<script>
    const openPopUp = (id_pengajuan_dana) => {
        ...
        formPenolakan.action = `/koperasi/dana/${id_pengajuan_dana}/status/Ditolak`;

    }
    const openPopUpTerima = (id_pengajuan_dana) => {

        const blackBg = document.getElementById('detailPopUpBlackbg');
        const detailPopUp = document.getElementById('detailPopUpTerima');
        const formPenolakan = document.getElementById('formPenolakan');
        blackBg.style.visibility = "visible";
        detailPopUp.style.visibility = "visible";
