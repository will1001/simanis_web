...
<div>
    ...
    <span class="mr-2"><a href="/koperasi/dashboard/ProfilBadanUsaha/{{$BadanUsaha[0]->id}}">1. Profil Badan Usaha</a></span>
    <span><a class="text-disetujuiTextColor" href="/koperasi/dashboard/suratRekomendasi/{{$BadanUsaha[0]->id}}">2. Surat Rekomendasi</a></span>
</div>
...
<div>
    <div>
        <form action="/koperasi/surat/downloadSurat/{{$BadanUsaha[0]->id}}" method="get">
